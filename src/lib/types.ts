...
export interface WorkMeta {
  ...
  blurb?: string;
  /**
   * 短編集（各章が独立した1編で、筋も登場人物も章をまたいで続かない）なら true。
   *
   * people.json / glossary.json は作品単位の1つの名前空間なので、短編集では
   * 10編ぶんの人物が同じ袋に入る。長編の作りのままだと読書画面で次の2つが壊れる:
   *   - 登場人物レールに他の編の人物まで並ぶ（「かき」は登場人物0人なのに31人並んだ）
   *   - 「ここまでのあらすじ」が前の章＝無関係な編の要約を出し、他編の結末をばらす
   * true のときは、レールをその章で言及される人物だけに絞り、あらすじを出さない。
   */
  anthology?: boolean;
}
